<div>
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Verifikasi Pencairan</div>
        <div class="ps-3">
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header bg-warning text-dark">
                    <h5 class="mb-0">Verifikasi Pengajuan Pencairan Dana Hibah</h5>
                </div>
                <div class="card-body">
                    <!-- Informasi Lembaga -->
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <p class="mb-2">
                                        <span class="badge bg-warning">{{ ucfirst($pencairan->status) }}</span>
                                    </p>
                                </div>
                                <div class="col-md-12">
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="timeline">
                        <div class="timeline-item {{ $pencairan->status == 'diajukan' ? 'active' : 'completed' }}">
            ...
            <div class="card mt-3">
                <div class="card-header bg-warning text-dark">
                    <h6 class="mb-0"><i class="bi bi-info-circle"></i> Panduan Verifikasi</h6>
                </div>
                <div class="card-body">
                    <ol class="mb-0" style="font-size: 0.9rem;">
                        <li>Periksa kelengkapan dokumen LPJ</li>
                        <li>Verifikasi laporan realisasi kegiatan</li>
                        <li>Cek dokumentasi kegiatan</li>
                        <li>Validasi kwitansi dan bukti pengeluaran</li>
                        <li>Pastikan jumlah pencairan sesuai</li>
