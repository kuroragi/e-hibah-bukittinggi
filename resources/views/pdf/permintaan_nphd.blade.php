    ...
    <div class="nphd-content">
        ...
        <table style="border-bottom: 2px black solid; margin-bottom: 1rem;">
            <tr>
                ...
                <td class="text-center">
                    <h1>{{ $data->lembaga->name }}</h1><br>
                    <h1>KOTA BUKITTINGGI</h1><br>
        ...
        <div class="container-fluid">
            ...
            <div class="mb-4">
                ...
                <table class="table">
                    <tr>
                        <td style="widows: 12ch;">Nomor</td>
                        <td>: XXX/XX/XX/XXX</td>
                        <td>Bukittinggi, {{ date('d-m-Y', strtotime($waktu['tanggal_penuh'])) }}</td>
                    </tr>
                    <tr>
                        <td>Lampiran</td>
                    ...
                    <tr class="pb-5">
                        <td></td>
                        <td colspan="2" style="padding-left:2ch;">Dana Hibah Tahun </td>
                    </tr>
                    ...
                    <tr>
                        <td></td>
                        <td colspan="2" class="tbold">Walikota Bukittinggi</td>
                    </tr>
                    <tr>
                        <td></td>
                        <td colspan="2" class="tbold">Cq. {{ $data->lembaga }}</td>
                    </tr>
                </table>
