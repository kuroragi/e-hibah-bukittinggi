...
<div class="nphd-content">
    ...
    <table style="border-bottom: 2px black solid; margin-bottom: 1rem;">
        <tr>
            ...
            <td style="width: 125px;"><img src="{{ public_path('assets/images/logo/bkt.png') }}" width="115px" alt="" />
            </td>
        </tr>
    </table>
    <div class="container-fluid">
        ...
        <div class="mb-4">
            <p class="paragraph-indent">
                Pada hari ini <span class="fw-bold">{{ $waktu['hari'] }}</span> tanggal <span class="fw-bold">{{
                    $waktu['tanggal'] }}</span> bulan <span class="fw-bold">{{ $waktu['bulan'] }}</span> Tahun
            ...
            <table class="table">
                <tr class="pb-3">
                    ...
                    <td style="width: 60%;"><span class="fw-bold">NIP. {{ $data->skpd?->detail?->nip_pimpinan }}</span>
                        selaku
                ...
                <tr>
                    ...
                    <td>{{ strtoupper($pimpinan_lembaga->name) }}
                    </td>
                    <td><span class="justify-content">Selaku {{ $data->lembaga?->pengurus[0]?->jabatan }}
                            ...
                            Bukittinggi, beralamat di {{ $data->lembaga?->alamat }} Selanjutnya disebut PIHAK KEDUA.
                    </td>
                </tr>
            </table>
        </div>
        ...
        <table class="w-100">
            ...
            <tr>
                <td style="width: 15px; height: 50px; padding-bottom: 1.5rem;">4</td>
